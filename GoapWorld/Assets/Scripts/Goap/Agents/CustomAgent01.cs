...
public class CustomAgent01<T, W> : MonoBehaviour, IReGoapAgent<T, W>, IReGoapAgentHelper {
    public string Name;
    ...
    protected enum PreviousPlanResult {
        Null,
        Failed,
        Interrupted,
        Suceeded
    ...
    protected virtual bool CalculateNewGoal(bool forceStart = false, PreviousPlanResult planResult = PreviousPlanResult.Null) {
        ...
        //        if (currentGoal.GetName() == "") {
        //            //Bank[] banks;
        //            //memory.GetWorldState().TryGetValue("banks", out banks);
        //        }
        //        break;
        //    default:
        //        break;
